...
final class CloudAPI {
    ...
    func parseLamp(_ json: JSONObject, fallbackHomeId: String = "") -> LampRecord? {
        ...
        let rawJSON = stateJSON.object("raw") ?? json.object("raw") ?? [:]
        ...
        let state = LampState(
            ...
            timerRemainingSeconds: Int64(max(0, stateJSON.int("timerRemainingSeconds", "timerRemaining") ?? json.int("timerRemainingSeconds") ?? 0)),
